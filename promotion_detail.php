...
<section class="shop spad">
    <div class="container">
        ...
        <?php if (mysqli_num_rows($productsResult) > 0) : ?>
            <div class="row mt-3">
                <div class="col-lg-12">
                    <h3 class="mb-3">Sản phẩm áp dụng khuyến mãi</h3>
                    <div class="row">
...
<style>
    ...
    /* Compact product display in promotion detail */
    .shop .row.mt-3 .product__item {
        margin-bottom: 0;
        background: transparent;
    }

    .shop .row.mt-3 .product__item__pic {
    ...
    .shop .row.mt-3 .product__item__pic img {
        width: 100%;
        height: auto;
        max-height: 150px;
        object-fit: cover;
    ...
    .shop .row.mt-3 .product__item__text {
        padding-top: 10px !important;
        padding-bottom: 0;
        text-align: center;
    }

    .shop .row.mt-3 .product__item__text h6 {
        margin-bottom: 5px;
        font-size: 14px;
        line-height: 1.4;
    }

    .shop .row.mt-3 .product__item__text h5 {
        margin-bottom: 0;
        font-size: 16px;
    }

    /* Reduce spacing between product items */
    .shop .row.mt-3 .row>div[class*="col-"] {
        padding-left: 8px;
        padding-right: 8px;
        margin-bottom: 15px;
    }
